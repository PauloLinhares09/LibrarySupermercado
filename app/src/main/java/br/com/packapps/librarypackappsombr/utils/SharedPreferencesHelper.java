...
import br.com.packapps.librarypackappsombr.LibraryApplication;
...
public class SharedPreferencesHelper {
    ...
    public static SharedPreferences getSharedPreferences() {
        return LibraryApplication.getContext().getSharedPreferences(DEFAULT_PREFERENCES, Context.MODE_PRIVATE);
    }
